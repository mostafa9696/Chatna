...
public class ProfileActivity extends AppCompatActivity {
    ...
    public void checRequestkState(){
        friendRequestDB.child(currentID.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.hasChild(visitedUserID)){
                    ...
                    friendDatabase.child(currentID.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if(dataSnapshot.hasChild(visitedUserID)){
